...
## Baseline archaeological entries

*(no prior archaeological carry-over on first Q4 run · this file establishes the baseline for future byte-identity reproduction checks)*
